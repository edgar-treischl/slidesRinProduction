...
<h1 style="font-family: 'Bangers', sans-serif; font-size: 65px; color: #ffff;">R in Production</h1>


<h2><a href="http://www.edgar-treischl.de" target="_blank" style="font-family: 'Bangers', sans-serif; font-size: 45px; color: #ffff;">Edgar J. Treischl</a></h2>
